...
public class CatDiamondSpawner : MonoBehaviour
{
    public static CatDiamondSpawner instance;
    ...
    IEnumerator SpawnRocketCoroutine()
    {
        ...
        while (true)
        {
            count = GameObject.FindGameObjectsWithTag("bule1").Length;
    ...
    {
        GameObject[] spawnedItems = GameObject.FindGameObjectsWithTag("bule1");
