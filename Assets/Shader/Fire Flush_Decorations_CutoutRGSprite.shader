Shader "Fire Flush/Decorations/CutoutRGSprite"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_0.xy = tex2D(_MainTex, u_xlat0_d.xy).xy;
          ...
          u_xlat0_d.xzw = ((-_RedColor.xyz) + _GreenColor.xyz);
          out_f.color.xyz = ((u_xlat10_0.yyy * u_xlat0_d.xzw) + _RedColor.xyz);
          out_f.color.w = 1;
          return out_f;
      }
