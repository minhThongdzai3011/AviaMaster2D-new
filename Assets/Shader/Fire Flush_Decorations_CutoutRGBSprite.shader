Shader "Fire Flush/Decorations/CutoutRGBSprite"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = ((-_RedColor.xyz) + _GreenColor.xyz);
          u_xlat0_d.xyw = ((u_xlat10_0.yyy * u_xlat1_d.xyz) + _RedColor.xyz);
          u_xlat1_d.xyz = ((-u_xlat0_d.xyw) + _BlueColor.xyz);
          out_f.color.xyz = ((u_xlat10_0.zzz * u_xlat1_d.xyz) + u_xlat0_d.xyw);
          out_f.color.w = 1;
          return out_f;
      }
