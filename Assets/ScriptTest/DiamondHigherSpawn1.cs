...
public class DiamondHigherSpawn1 : MonoBehaviour
{
    public static DiamondHigherSpawn1 instance;
    ...
    IEnumerator SpawnRocketCoroutine()
    {
        ...
        while (true)
        {
            count = GameObject.FindGameObjectsWithTag("green1").Length;
    ...
    {
        GameObject[] spawnedItems = GameObject.FindGameObjectsWithTag("green1");
